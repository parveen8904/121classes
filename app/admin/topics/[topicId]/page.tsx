        ...
        <details>
          ...
          <div className="form-card" style={{ marginTop: 10 }}>
            <div className="notice ok" style={{ fontSize: ".8rem", marginBottom: 10 }}>
              📤 <strong>Uploading to Bunny — cost rules:</strong> upload directly on Bunny as usual — originals are now auto-deleted after processing, so big files no longer waste storage. For faster uploads (optional): compress first with HandBrake → preset &ldquo;Fast 1080p30&rdquo; → tick &ldquo;Web Optimized&rdquo; → Start (a 15 GB recording becomes ~3 GB, same quality for students). Once the class is added &amp; published here, the offline-download copy is made <strong>automatically</strong> — no extra steps.
            </div>
