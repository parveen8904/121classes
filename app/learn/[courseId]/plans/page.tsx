      ...
      <section className="container" style={{ paddingTop: 40, paddingBottom: 70 }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 660, margin: "0 auto 18px" }}>
          ...
          <p className="muted">
            ...
            <strong style={{ color: "var(--text)" }}>plus FREE printed books couriered to your address on 9-month-or-longer plans</strong>.
          </p>
          <p style={{ marginTop: 8 }}>
        ...
        >
          ...
          <p style={{ fontSize: ".85rem", fontWeight: 700, margin: "6px 0 0" }}>
            📦 Gold plans of 9+ months include FREE printed books couriered to your shipping address — delivery within India only (the book PDFs are free for every student).
          </p>
          <p className="muted" style={{ fontSize: ".8rem", margin: "4px 0 0" }}>
