...
export const metadata = {
  ...
  description:
    "Have a startup idea or an early-stage venture? Nova Seed Capital — founded by CA Parveen Sharma — grooms new startups. Get in touch.",
};

const GRAD = "linear-gradient(135deg,#0d9488,#134e4a)";

// Nova Seed Capital — the founder's startup-grooming venture. This page tells
// students (and visitors) with a startup that they can reach out; the venture
// itself lives at novaseed.capital.
export default function StartupsPage() {
  return (
    <section className="section">
      {/* Hero */}
      <div style={{ background: GRAD, color: "#fff", borderRadius: 22, padding: "48px 28px", textAlign: "center" }}>
        <span style={{ display: "inline-block", background: "rgba(255,255,255,.18)", padding: "4px 14px", borderRadius: 999, fontSize: ".8rem", fontWeight: 700 }}>
          🚀 Nova Seed Capital
        </span>
        <h1 style={{ color: "#fff", fontSize: "clamp(1.7rem,4vw,2.4rem)", margin: "16px 0 10px" }}>
          Building a startup? Let&apos;s groom it together.
        </h1>
        <p style={{ maxWidth: 640, margin: "0 auto", fontSize: "1.05rem", color: "rgba(255,255,255,.95)" }}>
          <strong>Nova Seed Capital</strong> is a venture by <strong>CA Parveen Sharma</strong> where new startups are
          groomed — turning early ideas into disciplined, investable businesses.
        </p>
      ...
      <div className="grid grid-3" style={{ maxWidth: 980, margin: "0 auto" }}>
        {[
          { i: "💡", t: "An idea you believe in", d: "You have a business idea and want experienced hands to shape it into something real." },
          { i: "🌱", t: "An early-stage startup", d: "You've already started — now you need structure, financial discipline and grooming to grow." },
