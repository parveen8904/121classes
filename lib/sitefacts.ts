...
export async function getSiteFacts(): Promise<string> {
  ...
  lines.push("FOUNDER & LEAD FACULTY: CA Parveen Sharma (36+ years teaching CA; rank holder; specialises in Advanced Accounting & Financial Reporting).");
  ...
  lines.push("CONTACT: contact@caparveensharma.com · Office (visitors): W6/30, DLF Phase 3, Sector 24, Gurugram, Haryana 122010.");
